...
<section class="contact-one pt-120 pb-120">
    <div class="container">
        <div class="row">
            <h2 style="text-align:center;">Indusind Bank Personal Loan</h2>
            <div class="col-lg-12">
                <form class="form-one contact-form-validated">
                    <div class="row row-gutter-y-20 row-gutter-x-20">
                        ...
                        <div class="col-md-6">
                            <select placeholder="Loan Amount" name="loanamount">
                        ...
                        <div class="col-md-6">
                            <input type="hidden" value="indusind_personal_loan" name="name">
                        </div>
                        <div class="col-md-12">
                            <button type="submit" class="thm-btn">Submit</button><!-- /.thm-btn -->
                        </div><!-- /.col-md-6 -->
                    </div><!-- /.row -->
                </form>
            </div><!-- /.col-lg-8 -->

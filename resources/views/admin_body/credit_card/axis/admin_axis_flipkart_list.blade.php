...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            Axis Bank Flipkart Credit Card LIST
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Axis Bank Flipkart Credit Card LIST</li>
        </ol>
    </section>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $d -> url }}</td>
                                    <td>
                                        <a href="{{url('credit_card/axis/edit_admin_axis_flipkart/' . $d->id)}}"><i class="fa fa-pencil-square-o"

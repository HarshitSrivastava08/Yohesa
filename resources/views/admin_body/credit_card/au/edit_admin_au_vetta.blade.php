...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Update AU Bank Vetta Credit Card<small>Preview</small></h1>
        <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Update AU Bank Vetta Credit Card</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-default">
            <div class="box-body">
                <form action="{{route('update_admin_au_vetta' , $data->id)}}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">

...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>ICICI Bank Manchester United Signature Credit Credit Card<small>Preview</small></h1>
        <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">ICICI Bank Manchester United Signature Credit Credit Card</li>
        </ol>
    </section>

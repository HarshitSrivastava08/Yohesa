...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>Standard Chartered Super Value Titanium Cashback Credit Card<small>Preview</small></h1>
    <ol class="breadcrumb">
      <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>     
      <li class="active">Standard Chartered Super Value Titanium Cashback Credit Card</li>
    </ol>
  </section>

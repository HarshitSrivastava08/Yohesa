...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>HDFC Bank Indian Oil Credit Card<small>Preview</small></h1>
        <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">HDFC Bank Indian Oil Credit Card</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-default">
            <div class="box-body">
            <form method="post" action="{{route('edit_indian_oil_hdfc', $data->id )}}">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="first_name" name="first_name"
                                    placeholder="Enter First Name" value="{{ $data->first_name }}" required>

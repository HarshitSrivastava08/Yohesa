...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>HDFC Bank Infinia Credit Card<small>Preview</small></h1>
        <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">HDFC Bank Infinia Credit Card</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-default">
            <div class="box-body">
            <form method="post" action="{{route('edit_infinia_hdfc', $data->id )}}">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">

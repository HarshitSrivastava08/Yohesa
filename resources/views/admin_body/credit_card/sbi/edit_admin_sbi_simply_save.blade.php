...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Update SBI Bank Simply Save Credit Card<small>Preview</small></h1>
        <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Update SBI Bank Simply Save Credit Card</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-default">
            <div class="box-body">
            <form action="{{route('update_admin_sbi_simply_save' , $data->id)}}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="url" name="url" value="{{ $data->url }}" placeholder="Enter URL" required>
                            </div>
                        </div>
                        <div class="col-md-12">

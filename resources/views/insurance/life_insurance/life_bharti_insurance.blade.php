...
<section>
    <div class="container-fluid pb-5 do_1">
        <div class="row">
            <div class="col">
                <figure class="im_g"><img src="{{asset('assets/images/axisbank/life_bharti.jpg')}}" width="300"></figure>
            </div>
            <div class="col pt-5">
                <h4 class="airtel">Bharti AXA Life Insurance</h4>
            </div>
            <div class="col pt-5">
...
<div class="container pt-5">
    <p style="font-size: 17px; line-height:40px;">Bharti AXA Life Insurance offers a variety of life insurance products
        that provide financial security for you and your loved ones, ensuring peace of mind for the future.</p>

    <h2 style="font-weight:700;">Key Highlights of Bharti AXA Life Insurance</h2>
    <p style="font-size:17px;">Key highlights of Bharti AXA Life Insurance include:</p>

    <table id="example" class="table table-striped table-bordered" style="width:100%; line-height:30px;">
        <tbody>
            <tr>
                <td>Sum Assured</td>
                <td>Up to Rs. 2 Crore or more based on the chosen plan</td>
            </tr>
            <tr>
                <td>Policy Term</td>
            ...
            <tr>
                ...
                <td>Available with select plans, providing financial returns at maturity</td>
            </tr>
            <tr>
...
<section>
    <div class="container pt-5">
        <div class="row">
            <h2 style="font-weight: 700;">Features & Benefits of Bharti AXA Life Insurance</h2>
            ...
            <ul style="font-size: 17px; line-height:40px;">
                ...
                <li>Receive maturity benefits and bonuses with certain plans, assisting you in achieving your financial
                    objectives.</li>
            </ul>
        </div>
    </div>
...
<section class="faq-grid pt-12 pb-120">
    <div class="container">
        <h2 style="font-weight:700; text-align: center; padding-bottom: 20px;">Bharti AXA Life Insurance FAQs</h2>
        <div class="row row-gutter-y-20">
            <div class="col-lg-6">
                <div class="accrodion-grp faq-one-accrodion" data-grp-name="faq-one-accrodion-1">
                    <div class="accrodion  wow fadeInUp" data-wow-delay="0ms">
                        <div class="accrodion-title">
                            <h4>How to apply for Bharti AXA Life Insurance?<span class="accrodion-icon"></span></h4>
                        </div>
                        <div class="accrodion-content">
                            <div class="inner">
                                <p>Visit our website, choose your preferred life insurance plan, and fill out the online
                                    application form.</p>
                            </div>
                        </div>
                    </div>
                    <div class="accrodion active wow fadeInUp" data-wow-delay="0ms">
                        ...
                        <div class="accrodion-content">
                            <div class="inner">
                                <p>Submit the required documents, and our dedicated team will ensure a smooth and
                                    efficient claim settlement process.</p>
                            </div>
                        </div>
                    </div>
                    <div class="accrodion  wow fadeInUp" data-wow-delay="0ms">
                        <div class="accrodion-title">
                            <h4>Does Bharti AXA Life Insurance offer ULIP plans?<span class="accrodion-icon"></span>
                            </h4>
                        </div>
                        <div class="accrodion-content">
                            <div class="inner">
                                <p>Yes, Bharti AXA offers ULIP plans that provide both investment and insurance
                                    benefits.</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-6">
                <div class="accrodion-grp faq-one-accrodion" data-grp-name="faq-one-accrodion-2">
                    <div class="accrodion active wow fadeInUp" data-wow-delay="0ms">
                        <div class="accrodion-title">
                            <h4>Can I add riders to my Bharti AXA policy?<span class="accrodion-icon"></span></h4>
                        </div>
                        <div class="accrodion-content">
                            <div class="inner">

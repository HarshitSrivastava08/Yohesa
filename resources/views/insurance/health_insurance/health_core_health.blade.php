...
<section>
    <div class="container-fluid pb-5 do_1">
        <div class="row">
            <div class="col">
                <figure class="im_g"><img src="{{asset('assets/images/axisbank/health_core.png')}}" width="300"></figure>
            </div>
            <div class="col pt-5">
                <h4 class="airtel">Core Health Insurance</h4>
            </div>
            <div class="col pt-5">
...
<div class="container pt-5">
    <p style="font-size: 17px; line-height:40px;">Core Health Insurance offers extensive health coverage designed to
        protect you and your family from unforeseen medical expenses.</p>

    <h2 style="font-weight:700;">Key Highlights of Core Health Insurance</h2>
    <p style="font-size:17px;">The key highlights of Core Health Insurance include:</p>
    ...
    <table id="example" class="table table-striped table-bordered" style="width:100%; line-height:30px;">
        <tbody>
            ...
            <tr>
                ...
                <td>Access to over 5,000+ network hospitals across India.</td>
            </tr>
            <tr>
                <td>Age Limit</td>
...
<section>
    <div class="container pt-5">
        <div class="row">
            <h2 style="font-weight: 700;">Features & Benefits of Core Health Insurance</h2>
...
<section class="faq-grid pt-12 pb-120">
    <div class="container">
        <h2 style="font-weight:700; text-align: center; padding-bottom: 20px;"> Core Health Insurance FAQs</h2>
        <div class="row row-gutter-y-20">
            <div class="col-lg-6">
                <div class="accrodion-grp faq-one-accrodion" data-grp-name="faq-one-accrodion-1">
                    <div class="accrodion  wow fadeInUp" data-wow-delay="0ms">
                        <div class="accrodion-title">
                            <h4>How to apply for Core Health Insurance?<span class="accrodion-icon"></span></h4>
                        </div>
                        <div class="accrodion-content">
                            <div class="inner">
                                <p>To apply for Core Health Insurance, visit our website, select the Health Insurance
                                    Plan, and fill out the application form with the required details.</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-6">
                <div class="accrodion-grp faq-one-accrodion" data-grp-name="faq-one-accrodion-2">
                    <div class="accrodion active wow fadeInUp" data-wow-delay="0ms">
                        <div class="accrodion-title">
                            <h4>Can I port my health insurance to Core Health?<span class="accrodion-icon"></span></h4>
                        </div>
                        <div class="accrodion-content">
                            <div class="inner">
                                <p>Yes, you can port your existing health insurance policy to Core Health by following
